...
router.get('/', async function(req, res,next) {
  ...
  res.render('admin/admin-index',{admin:true,layout:'admin-layout',Dashboard:true,
...
router.get('/order-details',async(req,res,next)=>{
  try{
   adminHelper.getOrderDetails().then((data)=>{
    res.render('admin/order-details',{admin:true,layout:'admin-layout',Order:true,data})
   })
  }catch(err){
    next(err)
  }
